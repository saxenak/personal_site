        ...
        {!isMenuOpen && (
          ...
          >
            ...
            <div className="flex items-center gap-8">
              ...
              >
                <motion.a
                  href="https://instagram.com/kirtisaxena"
                  target="_blank"
                ...
                <span className="text-xs text-gray-500">1.2M</span>
              </motion.div>
              ...
              >
                <motion.a
                  href="https://tiktok.com/@kirtisaxena"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group"
                >
                ...
                <span className="text-xs text-gray-500">800K</span>
              </motion.div>
              ...
              >
                <motion.a
                  href="https://youtube.com/@kirtisaxena"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group"
                >
                ...
                <span className="text-xs text-gray-500">450K</span>
              </motion.div>
              ...
              >
                <motion.a
                  href="https://facebook.com/kirtisaxena"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group"
                >
                ...
                <span className="text-xs text-gray-500">180K</span>
              </motion.div>
            </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                Explore my modeling portfolio across different categories. Click on any category to view the full collection.
              </p>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-12 flex justify-between items-center">
              ...
              <button 
                ...
                className="px-4 py-2 text-sm hover:text-gray-400 transition-colors"
              >
                Back to Portfolio
              </button>
            </div>
