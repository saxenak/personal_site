...
const galleryImages: GalleryImage[] = [
  // Digitals
  { id: 'dig-1', src: '/images/modelling/digitals1.jpg', alt: 'Digitals comp', category: 'Digitals', styleFilters: ['Film', 'Fashion', 'Portraits'], credits: { photographer: 'Kabir O.', mua: 'Birgitta W. & Tatyana K.', muaLink: 'http://www.birgittamakeupartistry.com', hair: 'Angela D. & Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.' },   height: 'medium' },
  { id: 'dig-2', src: '/images/modelling/digitals2.jpg', alt: 'Digitals headshot', category: 'Digitals',styleFilters: ['Film', 'Fashion', 'Full Body'], credits: { photographer: 'Kabir O.', mua: 'Birgitta W. & Tatyana K.', muaLink: 'http://www.birgittamakeupartistry.com', hair: 'Angela D. & Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.' },  height: 'tall' },
  ...
  { id: 'edit-2', src: '/images/modelling/editorial2.jpg', alt: 'Editorial portrait', category: 'Editorial', styleFilters: ['Makeup & Hair', 'Fashion', 'Full Body'], credits: { photographer: 'Kabir O.', mua: 'Birgitta W. & Tatyana K.', muaLink: 'http://www.birgittamakeupartistry.com', hair: 'Angela D. & Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.' }, height: 'tall' },
  { id: 'edit-3', src: '/images/modelling/editorial3.jpg', alt: 'Editorial concept', category: 'Editorial', styleFilters: ['Makeup & Hair', 'Fashion', 'Full Body'], credits: { photographer: 'Julie M.', mua: 'Angelina L.', hair: 'Crystal M.', hairLink: 'https://www.dulcehairco.com' }, height: 'tall' },
  { id: 'edit-4', src: '/images/modelling/editorial4.jpg', alt: 'Editorial styling', category: 'Editorial', styleFilters: ['Film', 'Fashion', 'Full Body'], credits: { photographer: 'Amara A.', photographerLink: 'https://www.arw.photos', mua: 'Angelina L.', hair: 'Crystal M.', hairLink: 'https://www.dulcehairco.com' }, height: 'tall' },
  { id: 'edit-5', src: '/images/modelling/editorial5.jpg', alt: 'Editorial outdoor', category: 'Editorial', styleFilters: ['Accessories', 'Fashion', 'Full Body'], credits: { photographer: 'Hooman Z.', mua: 'Sandhya S.', hair: 'Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shiraz K.' }, height: 'tall' },
  // Editorial — Row 2: B&W (1,6,7,8)
  { id: 'edit-1', src: '/images/modelling/editorial1.jpg', alt: 'Editorial shoot', category: 'Editorial', styleFilters: ['Accessories', 'Fashion', 'B&W'], credits: { photographer: 'Kabir O.', mua: 'Birgitta W. & Tatyana K.', muaLink: 'http://www.birgittamakeupartistry.com', hair: 'Angela D. & Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.' }, height: 'tall' },
  ...
  { id: 'edit-8', src: '/images/modelling/editorial8.jpg', alt: 'Editorial artistic', category: 'Editorial', styleFilters: ['Full Body', 'Makeup & Hair', 'B&W'], credits: { photographer: 'Mattieau St.Cyr', photographerLink: 'https://www.manikkrealm.com', mua: 'Birgitta W. & Tatyana K.', muaLink: 'http://www.birgittamakeupartistry.com', hair: 'Angela D. & Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.' }, height: 'tall' },
  ...
  { id: 'edit-9', src: '/images/modelling/editorial9.JPG', alt: 'Editorial fashion', category: 'Editorial', styleFilters: ['Fashion', 'Makeup & Hair', 'Accessories'], credits: { photographer: 'Maxwell G. ', mua: 'Angelina L', hair: 'Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.' }, height: 'tall' },
  { id: 'edit-16', src: '/images/modelling/editorial16.jpg', alt: 'Editorial artistic', category: 'Editorial', styleFilters: ['Full Body', 'Makeup & Hair', 'Film'], credits: { photographer: 'Mattieau St.Cyr', photographerLink: 'https://www.manikkrealm.com', mua: 'Birgitta W. & Tatyana K.', muaLink: 'http://www.birgittamakeupartistry.com', hair: 'Angela D. & Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.' }, height: 'tall' },
  { id: 'edit-14', src: '/images/modelling/editorial14.jpg', alt: 'Editorial cinematic', category: 'Editorial', styleFilters: ['Accessories', 'Makeup & Hair', 'Publications' ], credits: { photographer: 'Amara A.', photographerLink: 'https://www.arw.photos', mua: 'Angelina L.', hair: 'Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Maryam S.' }, height: 'tall' },
  // Editorial — Row 4: 13,15,12
  { id: 'edit-13', src: '/images/modelling/editorial13.jpg', alt: 'Editorial scene', category: 'Editorial', styleFilters: ['Film', 'Makeup & Hair', 'B&W'], credits: { photographer: 'Mattieau St.Cyr', photographerLink: 'https://www.manikkrealm.com', mua: 'Birgitta W. & Tatyana K.', muaLink: 'http://www.birgittamakeupartistry.com', hair: 'Angela D. & Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.' }, height: 'medium' },
  ...
  { id: 'edit-10', src: '/images/modelling/editorial10.JPG', alt: 'Editorial lifestyle', category: 'Editorial', styleFilters: ['Makeup & Hair', 'Fashion', 'Full Body'], credits: { photographer: 'Kabir O.', mua: 'Birgitta W. & Tatyana K.', muaLink: 'http://www.birgittamakeupartistry.com', hair: 'Angela D. & Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.' }, height: 'medium' },
   // Commercial
  { id: 'comm-1', src: '/images/modelling/commercial1.jpg', alt: 'Commercial shoot', category: 'Commercial', styleFilters: ['Accessories', 'Fashion', 'Makeup & Hair'], credits: { photographer: 'Amara A.', photographerLink: 'https://www.arw.photos', mua: 'Khushi C. & Elisa S.', hair: 'Crystal M. & Darya K.', hairLink: 'https://www.dulcehairco.com', stylist: 'Roxsana B.', stylistLink: 'https://www.behance.net/roxsanabernal' }, height: 'tall' },
  { id: 'comm-2', src: '/images/modelling/commercial2.jpg', alt: 'Commercial campaign', category: 'Commercial', styleFilters: ['Accessories', 'Fashion', 'Full Body'], credits: { photographer: 'Amara A.', photographerLink: 'https://www.arw.photos', mua: 'Khushi C. & Elisa S.', hair: 'Crystal M. & Darya K.', hairLink: 'https://www.dulcehairco.com'}, height: 'medium' },
  ...
  { id: 'comm-8', src: '/images/modelling/commercial8.JPG', alt: 'Commercial lifestyle', category: 'Commercial', styleFilters: ['Accessories', 'Fashion', 'Makeup & Hair'], credits: { photographer: 'Amara A.', photographerLink: 'https://www.arw.photos', mua: 'Khushi C. & Elisa S.', hair: 'Crystal M. & Darya K.', hairLink: 'https://www.dulcehairco.com'}, height: 'medium' },
  // Swimsuit
  ...
  { id: 'beau-1', src: '/images/modelling/beauty1.jpeg', alt: 'Beauty closeup', category: 'Beauty', styleFilters: ['Accessories', 'Makeup & Hair', 'Portraits'], credits: { photographer: 'Josephine M.', mua: 'Angelina L.', hair: 'Crystal M.', hairLink: 'https://www.dulcehairco.com'}, height: 'medium'},
  { id: 'beau-2', src: '/images/modelling/beauty2.jpg', alt: 'Beauty glam', category: 'Beauty', styleFilters: ['Accessories', 'Makeup & Hair', 'Portraits'], credits: { photographer: 'Amara A.', photographerLink: 'https://www.arw.photos', mua: 'Angelina L.', hair: 'Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Maryam S.'}, height: 'medium'},
  ...
  { id: 'beau-4', src: '/images/modelling/beauty4.jpg', alt: 'Beauty portrait', category: 'Beauty', styleFilters: ['Accessories', 'Portraits', 'Makeup & Hair'], credits: { photographer: 'Naga', mua: 'Angelina L. & Khushi C.', hair: 'Crystal M. & Liah W.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.' }, height: 'tall' },
  ...
  { id: 'beau-7', src: '/images/modelling/beauty7.jpg', alt: 'Beauty glam', category: 'Beauty', styleFilters: ['Accessories', 'Portraits', 'Makeup & Hair'], credits: { photographer: 'Mattieau St.Cyr', photographerLink: 'https://www.manikkrealm.com', mua: 'Birgitta W. & Tatyana K.', muaLink: 'http://www.birgittamakeupartistry.com', hair: 'Angela D. & Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.' }, height: 'tall' },
  { id: 'beau-10', src: '/images/modelling/beauty10.jpg', alt: 'Beauty editorial', category: 'Beauty', styleFilters: ['Makeup & Hair', 'Full Body', 'Accessories'], credits: { photographer: 'Julie M.', mua: 'Angelina L.', hair: 'Crystal M. & Liah W.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.'}, height: 'tall' },
  // Row 3 - Beauty: 9,10,11,12
  { id: 'beau-11', src: '/images/modelling/beauty11.jpg', alt: 'Beauty lifestyle', category: 'Beauty', styleFilters: ['Makeup & Hair', 'Portraits', 'B&W'], credits: { photographer: 'Dakksh N.', mua: 'Khushi C.', hair: 'Crystal M.', hairLink: 'https://www.dulcehairco.com' }, height: 'tall' },
  { id: 'beau-12', src: '/images/modelling/beauty12.jpg', alt: 'Beauty portrait', category: 'Beauty', styleFilters: ['B&W', 'Portraits', 'Makeup & Hair'], credits: { photographer: 'Mattieau St.Cyr', photographerLink: 'https://www.manikkrealm.com', mua: 'Birgitta W. & Tatyana K.', muaLink: 'http://www.birgittamakeupartistry.com', hair: 'Angela D. & Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.' }, height: 'tall' },
  ...
  { id: 'intm-1', src: '/images/modelling/intimate1.jpg', alt: 'Intimate shoot', category: 'Intimate', styleFilters: ['Makeup & Hair'], credits: { photographer: 'Mattieau St.Cyr', photographerLink: 'https://www.manikkrealm.com', mua: 'Birgitta W. & Tatyana K.', muaLink: 'http://www.birgittamakeupartistry.com', hair: 'Angela D. & Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shanice W.' }, height: 'tall' },
  { id: 'intm-2', src: '/images/modelling/intimate2.jpg', alt: 'Intimate portrait', category: 'Intimate', styleFilters: ['Film', 'Fashion', 'Full Body'], credits: { photographer: 'Amara A.', photographerLink: 'https://www.arw.photos', mua: 'Khushi C. & Elisa S.', hair: 'Crystal M. & Darya K.', hairLink: 'https://www.dulcehairco.com', stylist: 'Samantha C.' }, height: 'medium' },
  { id: 'intm-3', src: '/images/modelling/intimate3.jpg', alt: 'Intimate studio', category: 'Intimate', styleFilters: ['Film', 'Fashion', 'Full Body'], credits: { photographer: 'Amara A.', photographerLink: 'https://www.arw.photos', mua: 'Khushi C. & Elisa S.', hair: 'Crystal M. & Darya K.', hairLink: 'https://www.dulcehairco.com', stylist: 'Samantha C.' }, height: 'tall' },
  ...
  { id: 'intm-9', src: '/images/modelling/intimate9.JPG', alt: 'Intimate artistic', category: 'Intimate', styleFilters: ['Portraits'], credits: { photographer: 'Josephine M.', mua: 'Angelina L', hair: 'Crystal M.', hairLink: 'https://www.dulcehairco.com'},  height: 'tall' },
  // Cultural - Row 1 - 1,2,3,4
  { id: 'cult-1', src: '/images/modelling/cultural1.jpg', alt: 'Cultural shoot', category: 'Cultural', styleFilters: ['Accessories', 'Fashion', 'Full Body'], credits: { photographer: 'Hooman Z.', mua: 'Sandhya S.', hair: 'Crystal M.', hairLink: 'https://www.dulcehairco.com', stylist: 'Shiraz K.' }, height: 'tall' },
                ...
                <div className="mt-3 flex flex-col gap-1.5">
                  ...
                  {lightboxImage.credits.hair && (
                    <span className="text-sm text-white">
                      ...
                      {lightboxImage.credits.hairLink ? (
                        <a
                          href={lightboxImage.credits.hairLink}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="underline hover:text-[#FD9635] transition-colors"
                          onClick={(e) => e.stopPropagation()}
