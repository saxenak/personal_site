      ...
      <div className="pt-32 px-8 max-w-6xl mx-auto">
        ...
        >
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light mb-6">My Artistic Journey</h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Art has been my sanctuary and voice of expression throughout my multifaceted career. 
              Beginning with sketches during training sessions and evolving into sophisticated oil paintings and mixed media works, 
              my artistic practice explores themes of movement, strength, and human resilience. Each piece reflects my experiences 
              as an athlete, engineer, and model - creating a unique perspective that bridges disciplines and celebrates the 
              beauty of the human spirit in motion.
            </p>
          </div>
