...
export default function Engineering() {
  ...
  const allProjects: Project[] = [
    ...
    },
   {
      ...
      skills: ['CTO', 'Technical Product Strategy', 'AI/ML', 'Biomedical Engineering', 'Revenue Strategy'],
      ...
      keyTakeawayAudio: '/audio/ajna-takeaway.mp3',
      link: 'https://h2i.utoronto.ca/startup/her2her/',
    ...
    },
 {
    ...
    },
  {
      ...
      keyTakeawayAudio: '/audio/ajna-takeaway.mp3',
      link: 'https://kirtisaxena.com/wrestling',
      startDate: 'August 2025',
      endDate: 'Current',
      category: 'work'
    },
